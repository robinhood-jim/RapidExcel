...
public class FileUtils {
    ...
    public static boolean mkDirReclusive(String path) throws FileAlreadyExistsException {
    ...
    public static boolean mkdir(String path) throws FileAlreadyExistsException {
        ...
        if(file.isDirectory()){
            ...
            throw new FileAlreadyExistsException("path already exists as file");
        }
    }
